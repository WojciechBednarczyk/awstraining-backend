...
```
docker tag filebeat-custom 761018867930.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```

```
docker push 761018867930.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```